      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <ul class="nav">
            ...
            <li class="scroll-to-section"><a href="#contact">Add Faculty</a></li>
            <li class="scroll-to-section"><a href="#subscribe">Delete Faculty</a></li>
            <li class="scroll-to-section"><a href="get_time_table.php">Time Table</a></li>
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="section-heading">
            <h2>Add <em>Records </em>of a <span>Faculty</span></h2>
            <div id="map">
        ...
        <div class="col-lg-5 align-self-center">
          <form id="contact" action="add_teacher.php" method="post">
            <div class="row">
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="teacherName" id="teacherName" placeholder="Faculty Name" required>
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
          ...
          <div class="inner-content">
            <div class="row">
              <div class="col-lg-10 offset-lg-1">
                ...
                <form id="subscribe" action="delete_teacher.php" method="post">
                  <input type="text" name="teacherId" id="teacherId" placeholder="Teacher ID" required="">
...
<div id="contact" class="contact-us section">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <div class="section-heading">
            <h2>Update <em>Records </em>of a <span>Faculty</span></h2>
            <div id="map">
              <iframe src="https://t4.ftcdn.net/jpg/06/25/93/03/360_F_625930300_RCif2F8QPzkuiC7TAEtj5QIwlumqwe3w.jpg" width="100%" height="360px" frameborder="0" style="border:0" allowfullscreen=""></iframe>
            </div>
          </div>
        ...
        <div class="col-lg-5 align-self-center">
          <form id="contact" action="update_teacher.php" method="post">
            <div class="row">
              <div class="col-lg-12">
                <fieldset>
                  <input type="number" name="teacher_id" id="teacher_id" placeholder="Faculty ID" required>
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="teacher_name" id="teacher_name" placeholder="Faculty Name" required>
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
              ...
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="period_id" id="period_id" placeholder="Period ID" required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
